  ...
  const cargarReportes = async () => {
    ...
    try {
      const [espacioRes, mesRes, usadosRes] = await Promise.all([
        fetch(`${API_URL}/reportes/por-espacio`, { credentials: 'include' }),
        fetch(`${API_URL}/reportes/por-mes`, { credentials: 'include' }),
        fetch(`${API_URL}/reportes/espacios-mas-usados`, { credentials: 'include' })
      ]);
